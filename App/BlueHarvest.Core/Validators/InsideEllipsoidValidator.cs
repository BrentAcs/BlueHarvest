...
public class InsideEllipsoidValidator<T> : EllipsoidValidator<T>
{
   public InsideEllipsoidValidator(double? maxXRadius = default, double? maxYRadius = default,
      double? maxZRadius = default)
   {
      RuleFor(p => p.XRadius)
